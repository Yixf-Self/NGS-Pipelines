...
########## Help Infromation ##########
my $HELP_g = '
        Welcome to use CISDA (ChIP-Seq Data Analyzer), version 0.1.5, 2015-04-21.    
        ...
        Usage: 
               perl  CISDA-1.pl    [-v]    [-h]    [-s boole]    [-i inputDir]    [-o outDir]  

        For instance: 
                     perl  CISDA-1.pl      -p yes       -i 1-FASTQ          -o 2-Filtered           
                     perl  CISDA-1.pl      --paired yes    --input 1-FASTQ     --output 2-Filtered    
...
my $version_g = "  CISDA (ChIP-Seq Data Analyzer), version 0.1.5, 2015-04-21";
