...
week1 <- read.table("danpos-profile-2/week1/week1_region_heatmap/methylation-2.bed.gene.week1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week2 <- read.table("danpos-profile-2/week2/week2_region_heatmap/methylation-2.bed.gene.week2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week4 <- read.table("danpos-profile-2/week4/week4_region_heatmap/methylation-2.bed.gene.week4.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week6 <- read.table("danpos-profile-2/week6/week6_region_heatmap/methylation-2.bed.gene.week6.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week8 <- read.table("danpos-profile-2/week8/week8_region_heatmap/methylation-2.bed.gene.week8.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
H3    <- read.table("danpos-profile-2/H3/H3_region_heatmap/methylation-2.bed.gene.H3.wig.heatmap.xls",             header=TRUE,   sep="",   quote = "",   comment.char = "")
dim(week1)
dim(week2)
dim(week4)
dim(week6)
...
needIndex <- c( (301-upStream):300, 301:(300+peakSize+downStream) )      ## maybe need to change
...
## peaks regions 
H3_peak     <- rowMeans(H3[, (upStream+1):(upStream+peakSize)],     na.rm = TRUE) 
week1_peak  <- rowMeans(week1[, (upStream+1):(upStream+peakSize)],  na.rm = TRUE) 
week2_peak  <- rowMeans(week2[, (upStream+1):(upStream+peakSize)],  na.rm = TRUE) 
week4_peak  <- rowMeans(week4[, (upStream+1):(upStream+peakSize)],  na.rm = TRUE)
week6_peak  <- rowMeans(week6[, (upStream+1):(upStream+peakSize)],  na.rm = TRUE) 
week8_peak  <- rowMeans(week8[, (upStream+1):(upStream+peakSize)],  na.rm = TRUE) 
length(H3_peak)
length(week1_peak)
length(week2_peak)
length(week4_peak)
...
## down streams
H3_down     <- rowMeans(H3[, (upStream+peakSize+1):(upStream+peakSize+downStream)],     na.rm = TRUE) 
week1_down  <- rowMeans(week1[, (upStream+peakSize+1):(upStream+peakSize+downStream)],  na.rm = TRUE) 
week2_down  <- rowMeans(week2[, (upStream+peakSize+1):(upStream+peakSize+downStream)],  na.rm = TRUE) 
week4_down  <- rowMeans(week4[, (upStream+peakSize+1):(upStream+peakSize+downStream)],  na.rm = TRUE)
week6_down  <- rowMeans(week6[, (upStream+peakSize+1):(upStream+peakSize+downStream)],  na.rm = TRUE) 
week8_down  <- rowMeans(week8[, (upStream+peakSize+1):(upStream+peakSize+downStream)],  na.rm = TRUE) 
length(H3_down)
length(week1_down)
length(week2_down)
length(week4_down)
...
#####################################
CairoSVG(file = "Figures-noscale/1-b-DNA Methylation-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_1,  aes(x=xAxis, y=dataframe_1$yAxis,  color=sampleType) )  +   
    xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("DNA Methylation Peaks") + 
  ...
  scale_x_continuous( breaks=c(-3, -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2", "3") ) + 
...
#############
CairoSVG(file = "Figures-noscale/1-c-DNA Methylation-errorbar-noscale.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
    ggplot(data=dataframe_1, aes(x=xAxis, y=dataframe_1$yAxis,  color=sampleType) )  +   
    xlab("Relative Distance to CSSs (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("DNA Methylation Peaks") + 
    scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) + 
...
wilcox.test(x= H3_1 [(1:peakSize)],                                                y = H3_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
wilcox.test(x= H3_1[((upStream+downStream+1):(upStream+peakSize+downStream))],     y = H3_1[((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")
wilcox.test(x= H3_1[(1:peakSize)],                                                  y = H3_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
wilcox.test(x= H3_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],     y = H3_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")

t.test(x= H3_1[ (1:peakSize)],                                                 y = H3_1[((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
t.test(x= H3_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],     y = H3_1[((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")
t.test(x= H3_1[ (1:peakSize)],                                                 y = H3_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
t.test(x= H3_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],     y = H3_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")

print( mean( H3_1 [(1:peakSize)]) )
print("###############################################################################################")
print( mean(H3_1[ ((upStream+1):(upStream+peakSize))]) )
print("###############################################################################################")
...
wilcox.test(x= week1_1[(1:peakSize)],                                                  y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
wilcox.test(x= week1_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],     y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")
wilcox.test(x= week1_1[(1:peakSize)],                                                  y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
wilcox.test(x= week1_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],     y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")

t.test(x= week1_1[ (1:peakSize)],                                                  y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
t.test(x= week1_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],      y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")
t.test(x= week1_1[ (1:peakSize)],                                                  y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
t.test(x= week1_1[ ((upStream+downStream+1):(upStream+peakSize+downStream))],      y = week1_1[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = FALSE,  var.equal = FALSE, conf.level = 0.95)
print("###############################################################################################")

print( mean( week1_1 [(1:peakSize)]) )
print("###############################################################################################")
print( mean(week1_1[ ((upStream+1):(upStream+peakSize))]) )
print("###############################################################################################")
...
CairoSVG(file = "Figures-noscale/2-a-occupancy-bar_allSites.svg",   width = 4, height =4, onefile = TRUE, bg = "white",  pointsize = 1 )
    ...
    xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "DNA Methylation Peaks ± 2000bp" )  +  
...
ggplot( dataframe_2, aes(x=sampleType) ) + 
  geom_errorbar( aes(ymin=min,ymax=max),  data=whisk(dataframe_2),   width = 0.3, size=0.4 ) +
  geom_boxplot( width=0.7,   aes(y=yAxis), outlier.colour="gray",  outlier.shape=1, outlier.size=0.004, size=0.4, fill="gray" ) +  
  xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "Down Streams of DNA Methylation Peaks" )  +  
  pTheme + guides(colour = guide_legend(override.aes = list(size=2.0, shape=22)))    + 
  geom_path( data = dataframePath1, aes(x = x, y = y), size=0.3 ) + annotate("text", x=1.5, y=3.4, label="p<3e-16", size=3.5) + 
  geom_path( data = dataframePath2, aes(x = x, y = y), size=0.3 ) + annotate("text", x=2.5, y=3.4, label="p<3e-16", size=3.5) +
  geom_path( data = dataframePath3, aes(x = x, y = y), size=0.3 ) + annotate("text", x=3.5, y=3.4, label="p<3e-16", size=3.5) +
...
ggplot( dataframe_2, aes(x=sampleType) ) + 
  geom_errorbar( aes(ymin=min,ymax=max),  data=whisk(dataframe_2),   width = 0.3, size=0.4 ) +
  geom_boxplot( width=0.7,   aes(y=yAxis), outlier.colour="gray",  outlier.shape=1, outlier.size=0.004, size=0.4, fill="gray" ) +  
  xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "Up Streams of DNA Methylation Peaks" )  +  
  pTheme + guides(colour = guide_legend(override.aes = list(size=2.0, shape=22)))    + 
  geom_path( data = dataframePath1, aes(x = x, y = y), size=0.3 ) + annotate("text", x=1.5, y=3.4, label="p<3e-16", size=3.5) + 
  geom_path( data = dataframePath2, aes(x = x, y = y), size=0.3 ) + annotate("text", x=2.5, y=3.4, label="p<3e-16", size=3.5) +
  geom_path( data = dataframePath3, aes(x = x, y = y), size=0.3 ) + annotate("text", x=3.5, y=3.4, label="p<3e-16", size=3.5) +
...
ggplot( dataframe_2, aes(x=sampleType) ) + 
  geom_errorbar( aes(ymin=min,ymax=max),  data=whisk(dataframe_2),   width = 0.3, size=0.4 ) +
  geom_boxplot( width=0.7,   aes(y=yAxis), outlier.colour="gray",  outlier.shape=1, outlier.size=0.004, size=0.4, fill="gray" ) +  
  xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "DNA Methylation Peaks" )  +  
  pTheme + guides(colour = guide_legend(override.aes = list(size=2.0, shape=22)))    + 
  geom_path( data = dataframePath1, aes(x = x, y = y), size=0.3 ) + annotate("text", x=1.5, y=3.4, label="p<3e-16", size=3.5) + 
  geom_path( data = dataframePath2, aes(x = x, y = y), size=0.3 ) + annotate("text", x=2.5, y=3.4, label="p<3e-16", size=3.5) +
  geom_path( data = dataframePath3, aes(x = x, y = y), size=0.3 ) + annotate("text", x=3.5, y=3.4, label="p<3e-16", size=3.5) +
...
ggplot(data=dataframe_3a, aes(x=xAxis, y=dataframe_3a$yAxis) )  +   
    xlab("Relative Distance (kb)") + ylab("Turnover Rate") + ggtitle("DNA Methylation Peaks") + ##ylim(2, 12) +
    geom_line(size=0.8) + 
    geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-3,  -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2",  "3") ) +    pTheme +
    theme( 
      line         = element_line(colour="black", size=1.0,  linetype=1,     lineend=NULL),                                                           ## all line elements.  局部优先总体,下面3个也是,只对非局部设置有效.   所有线属性.
      rect         = element_rect(colour="black", size=1.0,  linetype=1,     fill="transparent" ),                                                    ## all rectangluar elements.    hjust=1: 靠右对齐.   所有矩形区域属性.
...
CairoSVG(file = "Figures-noscale/3-a-halfLifeDis.svg",    width = 4,  height = 3,   onefile = TRUE, bg = "white",  pointsize = 1 )
    ...
    xlab("Relative Distance (kb)") + ylab("Half-life (weeks)") + ggtitle("DNA Methylation Peaks") + ##ylim(2, 12) +
    geom_line(size=0.8) + 
    geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
    scale_x_continuous( breaks=c(-3,  -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2",  "3") ) +  
    pTheme +
...
wilcox.test(x= turnoverDis_3[ (1:peakSize)],                                                           y = turnoverDis_3[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = TRUE,  conf.level = 0.95)
wilcox.test(x= turnoverDis_3[ (upStream + downStream + 1):(upStream + peakSize + downStream) ],        y = turnoverDis_3[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)
     t.test(x= turnoverDis_3[ (1:peakSize)],                                                           y = turnoverDis_3[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = TRUE,  conf.level = 0.95)
     t.test(x= turnoverDis_3[ (upStream + downStream + 1):(upStream + peakSize + downStream) ],        y = turnoverDis_3[ ((upStream+1):(upStream+peakSize))],     alternative = "two.sided",  mu = 0,  paired = TRUE,   var.equal = FALSE, conf.level = 0.95)

print( mean(turnoverDis_3[ (1:peakSize)]) )
print("###############################################################################################")
print( mean(turnoverDis_3[ ((upStream+1):(upStream+peakSize))]) )
print("###############################################################################################")
...
week1_4A <- mean(week1_1[(upStream+1):(upStream+peakSize)])  ##Peaks
week2_4A <- mean(week2_1[(upStream+1):(upStream+peakSize)])
week4_4A <- mean(week4_1[(upStream+1):(upStream+peakSize)])
week6_4A <- mean(week6_1[(upStream+1):(upStream+peakSize)])
week8_4A <- mean(week8_1[(upStream+1):(upStream+peakSize)])
...
week1_4D <- mean(week1_1[(upStream+peakSize+1):(upStream+peakSize+downStream)])  ## downstream
week2_4D <- mean(week2_1[(upStream+peakSize+1):(upStream+peakSize+downStream)])
week4_4D <- mean(week4_1[(upStream+peakSize+1):(upStream+peakSize+downStream)])
week6_4D <- mean(week6_1[(upStream+peakSize+1):(upStream+peakSize+downStream)])
week8_4D <- mean(week8_1[(upStream+peakSize+1):(upStream+peakSize+downStream)])
...
sampleType4 <- c( rep.int("DNA Methylation Peaks", 5),  rep.int("Peaks ± 2000bp", 5),  rep.int("Up streams of Peaks", 5),  rep.int("Down streams of Peaks", 5) ) 
...
ggplot( data = dataframe4, aes(x = xAxis, y = yAxis, color=sampleType ) ) + 
  geom_point(size=2) +  
  scale_colour_manual( values=c("DNA Methylation Peaks" = "gold4",  "Peaks ± 2000bp" = "green4",   "Up streams of Peaks"="red4", "Down streams of Peaks"="blue4") ,    breaks=c("DNA Methylation Peaks",  "Peaks ± 2000bp",  "Up streams of Peaks", "Down streams of Peaks") ) +  
  xlab("Time (week)") +   ylab("ln(H2B-GFP Signal)") +   ggtitle("Four Regions around DNA Methylation Peaks") + 
  geom_text( aes(x = 4.5, y = -0.69,   label = lmEquation( regression_4A )), parse = TRUE, family="serif", colour="gold4",       fontface=4,  size=3,  lineheight=1, alpha=0.09 ) +
  geom_text( aes(x = 4.5, y = -0.71,   label = lmEquation( regression_4B )), parse = TRUE, family="serif", colour="green4",      fontface=4,  size=3,  lineheight=1, alpha=0.09 ) +
  geom_text( aes(x = 4.5, y = -0.73,   label = lmEquation( regression_4C )), parse = TRUE, family="serif", colour="red4",        fontface=4,  size=3,  lineheight=1, alpha=0.09 ) +
  geom_text( aes(x = 4.5, y = -0.75,   label = lmEquation( regression_4D )), parse = TRUE, family="serif", colour="blue4",       fontface=4,  size=3,  lineheight=1, alpha=0.09 ) +  
...
ggplot(data=dataframe_5A, aes(x=xAxis) )  +   
  xlab("Half-life (week)") + 
  ylab("Relative frequency") + 
  ggtitle("DNA Methylation Peaks")  +  ylim(0, 0.25) +
...
## downstream
week2_5B <- rowSums(week2[, (upStream+peakSize+1):(upStream+peakSize+downStream)])
week6_5B <- rowSums(week6[, (upStream+peakSize+1):(upStream+peakSize+downStream)])
...
ggplot(data=dataframe_5B, aes(x=xAxis) )  +   
  xlab("Half-life (week)") + 
  ylab("Relative frequency") + 
  ggtitle("Down Streams of DNA Methylation Peaks")  +  ylim(0, 0.25) +
  geom_histogram(binwidth = 0.5, aes(y = (..count..)/sum(..count..), fill = ..count.. ) )  +  
  scale_x_continuous( breaks=c(0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30), labels=c('0', '3', '6', '9', '12', '15', '18', '21', '24', '27', '30') ) + 
  pTheme  +  guides( colour = guide_legend( override.aes = list(size=0.5) ) )
dev.off() 
...
ggplot(data=dataframe_5C, aes(x=xAxis) )  +   
  xlab("Half-life (week)") + 
  ylab("Relative frequency") + 
  ggtitle("Up streams of DNA Methylation Peaks")  +   ylim(0, 0.25) +
  geom_histogram(binwidth = 0.5, aes(y = (..count..)/sum(..count..), fill = ..count.. ) )  +  
  scale_x_continuous( breaks=c(0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30), labels=c('0', '3', '6', '9', '12', '15', '18', '21', '24', '27', '30') ) + 
  pTheme  +  guides( colour = guide_legend( override.aes = list(size=0.5) ) )
dev.off() 
...
NCV_frame <- ksmooth(x=Position_3,   y=NCV_6,     kernel = "normal",   bandwidth = 0.1)
NCV_6     <- NCV_frame$y
dataframe_6         <- data.frame(xAxis = Position_3, yAxis = NCV_6) 
...
ggplot(data=dataframe_6, aes(x=xAxis, y=dataframe_6$yAxis) )  +   
  xlab("Relative Distance (kb)") + ylab("NCV") + ggtitle("DNA Methylation Peaks") + ##ylim(2, 12) +
  geom_line(size=0.8) +    #scale_y_continuous( breaks=c(0.05, 0.07, 0.09, 0.11) ) + 
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  pTheme +
  theme( 
    line         = element_line(colour="black", size=1.0,  linetype=1,     lineend=NULL),                                                           ## all line elements.  局部优先总体,下面3个也是,只对非局部设置有效.   所有线属性.
    rect         = element_rect(colour="black", size=1.0,  linetype=1,     fill="transparent" ),                                                    ## all rectangluar elements.    hjust=1: 靠右对齐.   所有矩形区域属性.
    text         = element_text(family="sans",  face=NULL, colour="black", size=12,  hjust=NULL, vjust=NULL,   angle=NULL, lineheight=NULL),        ## all text elements.  "sans" for a sans-sans font. 所有文本相关属性.
...
#####################################
CairoSVG(file = "Figures-noscale/10-A-DNA Methylation-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10A,  aes(x=xAxis, y=dataframe_10A$yAxis,  color=sampleType) )  +   
  xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("DNA Methylation Peaks (High)") + 
  scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) +     
...
#####################################
CairoSVG(file = "Figures-noscale/10-B-DNA Methylation-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10B,  aes(x=xAxis, y=dataframe_10B$yAxis,  color=sampleType) )  +   
  xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("DNA Methylation Peaks (Middle)") + 
  scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) +     
  geom_line(size=0.5) + ylim(xlim10, ylim10) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-3, -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2", "3") ) + 
...
#####################################
CairoSVG(file = "Figures-noscale/10-C-DNA Methylation-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10C,  aes(x=xAxis, y=dataframe_10C$yAxis,  color=sampleType) )  +   
  xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("DNA Methylation Peaks (Low)") + 
  scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) +     
  geom_line(size=0.5) + ylim(xlim10, ylim10) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-3, -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2", "3") ) + 
...
#####################################
CairoSVG(file = "Figures-noscale/10-D-NCV.svg",   width = 6.5,  height = 3.5, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10D,  aes(x=xAxis, y=dataframe_10D$yAxis,  color=as.factor(sampleType)  )  ) +   
  xlab("Relative Distance (kb)") +  ylab("NCV") +  ggtitle("DNA Methylation Peaks") + 
...
NCV_middle_10_frame <-  ksmooth(x=Position_10E,   y=turnoverDis_10B,     kernel = "normal",   bandwidth = 0.1)
...
#####################################
CairoSVG(file = "Figures-noscale/10-E-turnover.svg",   width = 6.5,  height = 3.5, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10E,  aes(x=xAxis, y=dataframe_10E$yAxis,  color=as.factor(sampleType)  )  ) +   
  xlab("Relative Distance (kb)") +  ylab("Nucleosome Turnover Rate") +  ggtitle("DNA Methylation Peaks") + 
  scale_colour_manual( values=c("High" = "green4",  "Middle" = "green",   "Low"="yellowgreen") ,    breaks=c("High",  "Middle",  "Low") ) +  ## ditermined the order of legend   
  geom_line(size=0.5) + #ylim(0, 0.7) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-3, -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2", "3") ) + 
...
#####################################
CairoSVG(file = "Figures-noscale/10-F-occupancy.svg",   width = 6.5,  height = 3.5, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10F,  aes(x=xAxis, y=dataframe_10F$yAxis,  color=as.factor(sampleType)  )  ) +   
  xlab("Relative Distance (kb)") +  ylab("Nucleosome Occupancy Level") +  ggtitle("DNA Methylation Peaks") + 
  scale_colour_manual( values=c("High" = "green4",  "Middle" = "green",   "Low"="yellowgreen") ,    breaks=c("High",  "Middle",  "Low") ) +  ## ditermined the order of legend   
  geom_line(size=0.5) + #ylim(0, 0.7) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-3, -2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100,  3+peakSize/100), labels=c("-3", "-2",  "-1",  "5'",  "3'",  "1",  "2", "3") ) + 
