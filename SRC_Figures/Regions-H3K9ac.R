...
week1 <- read.table("danpos-profile/week1/week1_region_heatmap/H3K9ac_adult.bed.gene.week1.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week2 <- read.table("danpos-profile/week2/week2_region_heatmap/H3K9ac_adult.bed.gene.week2.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week4 <- read.table("danpos-profile/week4/week4_region_heatmap/H3K9ac_adult.bed.gene.week4.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week6 <- read.table("danpos-profile/week6/week6_region_heatmap/H3K9ac_adult.bed.gene.week6.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
week8 <- read.table("danpos-profile/week8/week8_region_heatmap/H3K9ac_adult.bed.gene.week8.wig.heatmap.xls",    header=TRUE,   sep="",   quote = "",   comment.char = "")
H3    <- read.table("danpos-profile/H3/H3_region_heatmap/H3K9ac_adult.bed.gene.H3.wig.heatmap.xls",             header=TRUE,   sep="",   quote = "",   comment.char = "")
dim(week1)
dim(week2)
dim(week4)
dim(week6)
...
#####################################
CairoSVG(file = "Figures-noscale/1-b-H3K9ac-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_1,  aes(x=xAxis, y=dataframe_1$yAxis,  color=sampleType) )  +   
    xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("H3K9ac Peaks") + 
...
#############
CairoSVG(file = "Figures-noscale/1-c-H3K9ac-errorbar-noscale.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
    ggplot(data=dataframe_1, aes(x=xAxis, y=dataframe_1$yAxis,  color=sampleType) )  +   
    xlab("Relative Distance to CSSs (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("H3K9ac Peaks") + 
    scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) + 
...
CairoSVG(file = "Figures-noscale/2-a-occupancy-bar_allSites.svg",   width = 4, height =4, onefile = TRUE, bg = "white",  pointsize = 1 )
    ...
    xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "H3K9ac Peaks ± 2000bp" )  +  
...
ggplot( dataframe_2, aes(x=sampleType) ) + 
  geom_errorbar( aes(ymin=min,ymax=max),  data=whisk(dataframe_2),   width = 0.3, size=0.4 ) +
  geom_boxplot( width=0.7,   aes(y=yAxis), outlier.colour="gray",  outlier.shape=1, outlier.size=0.004, size=0.4, fill="gray" ) +  
  xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "Down Streams of H3K9ac Peaks" )  +  
  pTheme + guides(colour = guide_legend(override.aes = list(size=2.0, shape=22)))    + 
  geom_path( data = dataframePath1, aes(x = x, y = y), size=0.3 ) + annotate("text", x=1.5, y=3.4, label="p<3e-16", size=3.5) + 
  geom_path( data = dataframePath2, aes(x = x, y = y), size=0.3 ) + annotate("text", x=2.5, y=3.4, label="p<3e-16", size=3.5) +
  geom_path( data = dataframePath3, aes(x = x, y = y), size=0.3 ) + annotate("text", x=3.5, y=3.4, label="p<3e-16", size=3.5) +
...
ggplot( dataframe_2, aes(x=sampleType) ) + 
  geom_errorbar( aes(ymin=min,ymax=max),  data=whisk(dataframe_2),   width = 0.3, size=0.4 ) +
  geom_boxplot( width=0.7,   aes(y=yAxis), outlier.colour="gray",  outlier.shape=1, outlier.size=0.004, size=0.4, fill="gray" ) +  
  xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "Up Streams of H3K9ac Peaks" )  +  
  pTheme + guides(colour = guide_legend(override.aes = list(size=2.0, shape=22)))    + 
  geom_path( data = dataframePath1, aes(x = x, y = y), size=0.3 ) + annotate("text", x=1.5, y=3.4, label="p<3e-16", size=3.5) + 
  geom_path( data = dataframePath2, aes(x = x, y = y), size=0.3 ) + annotate("text", x=2.5, y=3.4, label="p<3e-16", size=3.5) +
  geom_path( data = dataframePath3, aes(x = x, y = y), size=0.3 ) + annotate("text", x=3.5, y=3.4, label="p<3e-16", size=3.5) +
...
ggplot( dataframe_2, aes(x=sampleType) ) + 
  geom_errorbar( aes(ymin=min,ymax=max),  data=whisk(dataframe_2),   width = 0.3, size=0.4 ) +
  geom_boxplot( width=0.7,   aes(y=yAxis), outlier.colour="gray",  outlier.shape=1, outlier.size=0.004, size=0.4, fill="gray" ) +  
  xlab( "Time (week)" ) + ylab( "H2B-GFP Signal" ) + ggtitle( "H3K9ac Peaks" )  +  
  pTheme + guides(colour = guide_legend(override.aes = list(size=2.0, shape=22)))    + 
  geom_path( data = dataframePath1, aes(x = x, y = y), size=0.3 ) + annotate("text", x=1.5, y=3.4, label="p<3e-16", size=3.5) + 
  geom_path( data = dataframePath2, aes(x = x, y = y), size=0.3 ) + annotate("text", x=2.5, y=3.4, label="p<3e-16", size=3.5) +
  geom_path( data = dataframePath3, aes(x = x, y = y), size=0.3 ) + annotate("text", x=3.5, y=3.4, label="p<3e-16", size=3.5) +
...
ggplot(data=dataframe_3a, aes(x=xAxis, y=dataframe_3a$yAxis) )  +   
    xlab("Relative Distance (kb)") + ylab("Turnover Rate") + ggtitle("H3K9ac Peaks") + ##ylim(2, 12) +
    geom_line(size=0.8) + 
    geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
    scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  
    pTheme +
...
CairoSVG(file = "Figures-noscale/3-a-halfLifeDis.svg",    width = 4,  height = 3,   onefile = TRUE, bg = "white",  pointsize = 1 )
    ...
    xlab("Relative Distance (kb)") + ylab("Half-life (weeks)") + ggtitle("H3K9ac Peaks") + ##ylim(2, 12) +
    geom_line(size=0.8) + 
    geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
    scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  
    pTheme +
...
sampleType4 <- c( rep.int("H3K9ac Peaks", 5),  rep.int("Peaks ± 2000bp", 5),  rep.int("Up streams of Peaks", 5),  rep.int("Down streams of Peaks", 5) ) 
...
ggplot( data = dataframe4, aes(x = xAxis, y = yAxis, color=sampleType ) ) + 
  geom_point(size=2) +  
  scale_colour_manual( values=c("H3K9ac Peaks" = "gold4",  "Peaks ± 2000bp" = "green4",   "Up streams of Peaks"="red4", "Down streams of Peaks"="blue4") ,    breaks=c("H3K9ac Peaks",  "Peaks ± 2000bp",  "Up streams of Peaks", "Down streams of Peaks") ) +  
  xlab("Time (week)") +   ylab("ln(H2B-GFP Signal)") +   ggtitle("Four Regions around H3K9ac Peaks") + 
...
ggplot(data=dataframe_5A, aes(x=xAxis) )  +   
  xlab("Half-life (week)") + 
  ylab("Relative frequency") + 
  ggtitle("H3K9ac Peaks")  +  ylim(0, 0.25) +
...
ggplot(data=dataframe_5B, aes(x=xAxis) )  +   
  xlab("Half-life (week)") + 
  ylab("Relative frequency") + 
  ggtitle("Down Streams of H3K9ac Peaks")  +  ylim(0, 0.25) +
  geom_histogram(binwidth = 0.5, aes(y = (..count..)/sum(..count..), fill = ..count.. ) )  +  
  scale_x_continuous( breaks=c(0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30), labels=c('0', '3', '6', '9', '12', '15', '18', '21', '24', '27', '30') ) + 
  pTheme  +  guides( colour = guide_legend( override.aes = list(size=0.5) ) )
dev.off() 
...
ggplot(data=dataframe_5C, aes(x=xAxis) )  +   
  xlab("Half-life (week)") + 
  ylab("Relative frequency") + 
  ggtitle("Up streams of H3K9ac Peaks")  +   ylim(0, 0.25) +
  geom_histogram(binwidth = 0.5, aes(y = (..count..)/sum(..count..), fill = ..count.. ) )  +  
  scale_x_continuous( breaks=c(0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30), labels=c('0', '3', '6', '9', '12', '15', '18', '21', '24', '27', '30') ) + 
  pTheme  +  guides( colour = guide_legend( override.aes = list(size=0.5) ) )
dev.off() 
...
ggplot(data=dataframe_6, aes(x=xAxis, y=dataframe_6$yAxis) )  +   
  xlab("Relative Distance (kb)") + ylab("NCV") + ggtitle("H3K9ac Peaks") + ##ylim(2, 12) +
...
#####################################
CairoSVG(file = "Figures-noscale/10-A-H3K9ac-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10A,  aes(x=xAxis, y=dataframe_10A$yAxis,  color=sampleType) )  +   
  xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("H3K9ac Peaks (High)") + 
  scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) +     
...
#####################################
CairoSVG(file = "Figures-noscale/10-B-H3K9ac-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10B,  aes(x=xAxis, y=dataframe_10B$yAxis,  color=sampleType) )  +   
  xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("H3K9ac Peaks (Middle)") + 
  scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) +     
  geom_line(size=0.5) + ylim(xlim10, ylim10) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  
...
#####################################
CairoSVG(file = "Figures-noscale/10-C-H3K9ac-occupancy.svg",   width = 4.5,  height = 3, onefile = TRUE, bg = "white",  pointsize = 1 )
ggplot( data=dataframe_10C,  aes(x=xAxis, y=dataframe_10C$yAxis,  color=sampleType) )  +   
  xlab("Relative Distance (kb)") +  ylab("H2B-GFP Signal") +  ggtitle("H3K9ac Peaks (Low)") + 
  scale_colour_manual( values=c("green4",  "green",  "yellowgreen", "gold", "gold4") ) +     
  geom_line(size=0.5) + ylim(xlim10, ylim10) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  
...
ggplot( data=dataframe_10D,  aes(x=xAxis, y=dataframe_10D$yAxis,  color=as.factor(sampleType)  )  ) +   
  xlab("Relative Distance (kb)") +  ylab("NCV") +  ggtitle("H3K9ac Peaks") + 
...
ggplot( data=dataframe_10E,  aes(x=xAxis, y=dataframe_10E$yAxis,  color=as.factor(sampleType)  )  ) +   
  xlab("Relative Distance (kb)") +  ylab("Nucleosome Turnover Rate") +  ggtitle("H3K9ac Peaks") + 
  scale_colour_manual( values=c("High" = "green4",  "Middle" = "green",   "Low"="yellowgreen") ,    breaks=c("High",  "Middle",  "Low") ) +  ## ditermined the order of legend   
  geom_line(size=0.5) + #ylim(0, 0.7) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  
...
ggplot( data=dataframe_10F,  aes(x=xAxis, y=dataframe_10F$yAxis,  color=as.factor(sampleType)  )  ) +   
  xlab("Relative Distance (kb)") +  ylab("Nucleosome Occupancy Level") +  ggtitle("H3K9ac Peaks") + 
  scale_colour_manual( values=c("High" = "green4",  "Middle" = "green",   "Low"="yellowgreen") ,    breaks=c("High",  "Middle",  "Low") ) +  ## ditermined the order of legend   
  geom_line(size=0.5) + #ylim(0, 0.7) +
  geom_vline(xintercept=0, lty=2, col="gray", size=0.5) +  geom_vline(xintercept=peakSize/100, lty=2, col="gray", size=0.5) + 
  scale_x_continuous( breaks=c(-2,  -1,  0,  0+peakSize/100, 1+peakSize/100,  2+peakSize/100), labels=c("-2",  "-1",  "5'",  "3'",  "1",  "2") ) +  
