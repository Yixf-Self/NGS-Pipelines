...
########## Help Infromation ##########
my $HELP_g = '
        Welcome to use RASDA-0.pl (RNA-Seq Analyzer), version 0.1.5, 2015-04-21.    
        RASDA-0.pl is a Pipeline for Single-end and Paired-end RNA-seq Data Analysis by Integrating Lots of Softwares.
        ...
        Usage: 
               perl  RASDA-0.pl-0.pl    [-v]    [-h]    [-s boole]    [-i inputDir]    [-o outDir]  

        For instance: 
                     perl  RASDA-0.pl-0.pl      -s yes       -i 0-SRA          -o 1-FASTQ           
                     perl  RASDA-0.pl-0.pl      --sra yes    --input 0-SRA     --output 1-FASTQ    
...
my $version_g = "  RASDA-0.pl (RNA-Seq Analyzer), version 0.1.5, 2015-04-21";
...
if($boole_g == 1) {
    ...
    print '    Please see help message by using "perl  RASDA-0.pl-0.pl  -h" ';
    print "\n\n";
    exit 0;
}
