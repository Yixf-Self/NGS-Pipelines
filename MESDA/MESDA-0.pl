...
########## Help Infromation ##########
my $HELP_g = '
        Welcome to use MESDA (MethylC-seq Analyzer), version 0.1.5, 2015-04-21.    
        ...
        Usage: 
               perl  MESDA-0.pl    [-v]    [-h]    [-s boole]    [-i inputDir]    [-o outDir]  

        For instance: 
                     perl  MESDA-0.pl      -s yes       -i 0-SRA          -o 1-FASTQ           
                     perl  MESDA-0.pl      --sra yes    --input 0-SRA     --output 1-FASTQ    
...
my $version_g = "    MESDA (MethylC-seq Analyzer), version 0.1.5, 2015-04-21";
...
if($boole_g == 1) {
    ...
    print '    Please see help message by using "perl  MESDA-0.pl  -h" ';
    print "\n\n";
    exit 0;
}
